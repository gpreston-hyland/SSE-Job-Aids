...
<@layout.registrationLayout displayInfo=social.displayInfo; section>
    ...
    <#elseif section = "form">
        <div>
            <img class="logo" width="400px" src="${url.resourcesPath}/img/Argumentum.png" alt="Alfresco">
        </div>
        <div class="box-container">
            <div>
                <p class="application-name">Argumentum Login</p>
            </div>
        <#if realm.password>
            <div>
        ...
        <div>
            <b><p style="color:white" class="copyright">&copy; ${msg("copyright", "${.now?string('yyyy')}")}</p></b>
        </div>
    </#if>
